...
Note that the original docs said to install json with luarocks, but it doesn't seem to be available, so I downloaded it from [rxi/json.lua: A lightweight JSON library for Lua](https://github.com/rxi/json.lua) and put it my Lua PATH.
