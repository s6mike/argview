...
module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		jscs: {
			src: ['src/clipboard.js', 'src/content.js', 'src/dom-map-view.js', 'src/dom-map-widget.js', 'src/hammer-draggable.js'],
			options: {
				config: '.jscsrc',
				reporter: 'inline'
			}
		...
		jshint: {
			all: ['src/clipboard.js', 'src/content.js', 'src/dom-map-view.js', 'src/dom-map-widget.js', 'src/hammer-draggable.js']
		},
		jasmine: {
			all: {
				src: ['src/*.js'],
