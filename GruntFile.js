...
module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		jscs: {
			src: ['src/clipboard.js', 'src/content.js', 'src/dom-map-view.js', 'src/dom-map-widget.js', 'src/hammer-draggable.js', 'src/image-drop-widget.js'],
			options: {
				config: '.jscsrc',
				reporter: 'inline'
			}
		...
		jshint: {
			all: ['src/clipboard.js', 'src/content.js', 'src/dom-map-view.js', 'src/dom-map-widget.js', 'src/hammer-draggable.js', 'src/image-drop-widget.js']
		},
		jasmine: {
			all: {
				src: ['src/*.js'],
