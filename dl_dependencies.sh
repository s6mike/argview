...
curl http://d3lp1msu2r81bx.cloudfront.net/kjs/js/lib/kinetic-v4.7.1.js > lib/kinetic-v4.7.1.js
...
curl http://mindmup.s3.amazonaws.com/lib/jquery.mousewheel-3.1.3.js > lib/jquery.mousewheel-3.1.3.js
