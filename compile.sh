...
cat kinetic-src/kinetic.connector.js kinetic-src/kinetic.link.js kinetic-src/kinetic.clip.js kinetic-src/kinetic.idea.js kinetic-src/kinetic-mediator.js kinetic-src/map-widget.js > pub/kinetic-mapjs-compiled.js
