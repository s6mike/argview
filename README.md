...
|[![Argument Map Example 1 in mapjs format](docs/mapjs-example-brunellus-argmap-theme.png)](test/input/html/example-updated_.html "Argument Mapjs Example 1 - Brunellus")|
|-------------------------------|
...
## Generating Interactive Argument Maps (mapjs)
 ...
 |[![Argument Map Example 1 in mapjs format, embedded in html page](docs/mapjs-in-html-example.png)](test/input/html/example-updated_.html "Argument Mapjs Example 1")|
 |----------------|
