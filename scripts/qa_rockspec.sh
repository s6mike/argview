...
luarocks --lua-dir="$(brew --prefix)/opt/lua@5.3" --lua-version=5.3 make --only-deps "$rockspec_file" # This is for local/conda install only: YAML_LIBDIR="$CONDA_PREFIX/lib/"
