...
#   QUESTION: Or could I run getvar from within makefile instead?
...
PATH_DIR_CONFIG_MAPJS_PROCESSED=$(getvar PATH_DIR_CONFIG_MAPJS_PROCESSED)
PATH_DIR_CONFIG_MAPJS=$(getvar PATH_DIR_CONFIG_MAPJS)
PATH_FILE_CONFIG_MAPJS_PATHS_PROCESSED=$(getvar PATH_FILE_CONFIG_MAPJS_PATHS_PROCESSED)
PATH_FILE_ENV_MAPJS_PROCESSED=$(getvar PATH_FILE_ENV_MAPJS_PROCESSED)
...
export WORKSPACE PATH_DIR_CONFIG_ARGMAP DIR_PROCESSED PATH_DIR_CONFIG_MAPJS PATH_DIR_CONFIG_MAPJS_PROCESSED
...
export PATH_FILE_CONFIG_MAPJS_PATHS_PROCESSED PATH_FILE_CONFIG_MAPJS_PROCESSED PATH_FILE_ENV_MAPJS_PROCESSED
