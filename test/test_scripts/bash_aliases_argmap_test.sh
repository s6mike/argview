...
alias argmf='rm $DIR_PUBLIC_OUTPUT/html/example1-clearly-false-white-swan-simplified-1mapjs-fragment.html; md2htm test/input/markdown/example1-clearly-false-white-swan-simplified-1mapjs.md'
